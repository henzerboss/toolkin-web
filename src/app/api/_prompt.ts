...
export function buildSystemInstruction(locale: string): string {
  ...
  return [
    ...
    '',
    'GAMES. Every game goes into a Sandbox. Not "usually" — always.',
    'Snake, breakout, air hockey, pong, tetris, 2048, minesweeper, memory, simon,',
    'sliding puzzle, tic-tac-toe, flappy — all of them. Buttons named "Break a block"',
    'or "Red / Blue" are not a game, they are a broken imitation of one.',
    'A game needs a canvas and a loop, so build it as real HTML/JS:',
    ...
    '  { "type": "Stat", "label": "Best", "value": "{{best | integer}}" }',
    '  { "type": "Chart", "label": "Recent games", "values": "recordValues" }',
    '',
    'QUALITY RULES:',
